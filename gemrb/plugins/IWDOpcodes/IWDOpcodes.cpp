...
{
	if (0) print( "fx_ac_vs_damage_type_modifier_iwd2 (%2d): AC Modif: %d ; Type: %d ; MinLevel: %d ; MaxLevel: %d\n", fx->Opcode, fx->Parameter1, fx->Parameter2, (int) fx->DiceSides, (int) fx->DiceThrown );
...
{
	if (0) print( "fx_draw_upon_holy_might (%2d): Mod: %d, Type: %d\n", fx->Opcode, fx->Parameter1, fx->Parameter2 );
...
{
	if (0) print( "fx_fade_rgb (%2d): RGB:%x\n", fx->Opcode, fx->Parameter1 );
...
{
	if (0) print( "fx_iwd_visual_spell_hit (%2d): Type: %d\n", fx->Opcode, fx->Parameter2 );
	if (!Owner) {
		return FX_NOT_APPLIED;
	}
...
{
	if (0) print( "fx_cold_damage (%2d): Damage %d\n", fx->Opcode, fx->Parameter1 );
...
{
	if (0) print( "fx_chill_touch_panic (%2d)\n", fx->Opcode);
	ieDword state;
...
{
	if (0) print( "fx_crushing_damage (%2d): Damage %d\n", fx->Opcode, fx->Parameter1 );
...
{
	if (0) print( "fx_save_bonus (%2d): Bonus %d Type: %d\n", fx->Opcode, fx->Parameter1, fx->Parameter2 );
...
{
	if (0) print( "fx_iwd_monster_summoning (%2d): ResRef:%s Anim:%s Type: %d\n", fx->Opcode, fx->Resource, fx->Resource2, fx->Parameter2 );
...
{
	if (0) print( "fx_vampiric_touch (%2d): ResRef:%s Type: %d\n", fx->Opcode, fx->Resource, fx->Parameter2 );
...
{
	if (0) print( "fx_animate_dead (%2d): ResRef:%s Type: %d\n", fx->Opcode, fx->Resource, fx->Parameter2 );
	//check the summoning limit?
	if (!target) {
		return FX_NOT_APPLIED;
	}
...
{
	if (0) print( "fx_prayer (%2d): Type: %d\n", fx->Opcode, fx->Parameter2 );
	ieDword value;
...
{
	if (0) print( "fx_summon_monster2 (%2d): ResRef:%s Type: %d\n", fx->Opcode, fx->Resource, fx->Parameter2 );
...
{
	if (0) print( "fx_burning_blood (%2d): Type: %d\n", fx->Opcode, fx->Parameter2 );
...
{
	if (0) print( "fx_burning_blood2 (%2d): Count: %d Type: %d\n", fx->Opcode, fx->Parameter1, fx->Parameter2 );
...
{
	if (0) print( "fx_summon_shadow_monster (%2d): ResRef:%s Type: %d\n", fx->Opcode, fx->Resource, fx->Parameter2 );
...
{
	if (0) print( "fx_recitation (%2d): Type: %d\n", fx->Opcode, fx->Parameter2 );
	ieDword value;
...
{
	if (0) print( "fx_lich_touch (%2d): Type: %d\n", fx->Opcode, fx->Parameter2 );
	if (STAT_GET(IE_GENERAL)==GEN_UNDEAD) {
		return FX_NOT_APPLIED;
	}
...
{
	if (0) print( "fx_remove_effects (%2d): ResRef:%s Type: %d\n", fx->Opcode, fx->Resource, fx->Parameter2 );
...
{
	if (0) print( "fx_umberhulk_gaze (%2d): Duration: %d\n", fx->Opcode, fx->Parameter1);
...
{
	if (0) print( "fx_zombie_lord_aura (%2d): Duration: %d\n", fx->Opcode, fx->Parameter1);
...
{
	if (0) print( "fx_summon_creature2 (%2d): ResRef:%s Anim:%s Type: %d\n", fx->Opcode, fx->Resource, fx->Resource2, fx->Parameter2 );
...
{
	if (0) print( "fx_summon_pomab (%2d): ResRef:%s Anim:%s Type: %d\n", fx->Opcode, fx->Resource, fx->Resource2, fx->Parameter2 );
...
{
	if (0) print( "fx_static_charge (%2d): Count: %d \n", fx->Opcode, fx->Parameter1 );
...
{
	if (0) print( "fx_eye_of_the_mind (%2d)\n", fx->Opcode );
...
{
	if (0) print( "fx_eye_of_the_sword (%2d)\n", fx->Opcode );
...
{
	if (0) print( "fx_eye_of_the_mage (%2d)\n", fx->Opcode );
...
{
	if (0) print( "fx_eye_of_the_spirit (%2d)\n", fx->Opcode );
...
{
	if (0) print( "fx_eye_of_fortitude (%2d)\n", fx->Opcode );
...
{
	if (0) print( "fx_remove_seven_eyes (%2d): Type: %d\n", fx->Opcode, fx->Parameter2 );
...
{
	if (0) print( "fx_remove_effect (%2d): Type: %d\n", fx->Opcode, fx->Parameter2 );
	if (fx->Resource[0])
	{
...
{
	if (0) print( "fx_soul_eater (%2d): Damage %d\n", fx->Opcode, fx->Parameter1 );
...
{
	if (0) print( "fx_shroud_of_flame (%2d): Type: %d\n", fx->Opcode, fx->Parameter2 );
...
{
	if (0) print( "fx_shroud_of_flame2 (%2d)\n", fx->Opcode );
...
{
	if (0) print( "fx_animal_rage (%2d): Mode: %d\n", fx->Opcode, fx->Parameter2 );
...
{
	if (0) print( "fx_turn_undead2 (%2d): Level: %d Type %d\n", fx->Opcode, fx->Parameter1, fx->Parameter2 );
	switch (fx->Parameter2)
	{
	case 0: //command
...
{
	if (0) print( "fx_vitriolic_sphere (%2d): Damage %d\n", fx->Opcode, fx->Parameter1 );
	//timing
	if (core->GetGame()->GameTime%6) {
		return FX_APPLIED;
	}
...
{
	if (0) print( "fx_floattext (%2d): StrRef:%d Type: %d\n", fx->Opcode, fx->Parameter1, fx->Parameter2 );
	switch (fx->Parameter2)
	{
	case 1:
...
{
	if (0) print( "fx_mace_of_disruption (%2d): ResRef:%s Anim:%s Type: %d\n", fx->Opcode, fx->Resource, fx->Resource2, fx->Parameter2 );
...
{
	if (0) print( "fx_set_state (%2d): Type: %d\n", fx->Opcode, fx->Parameter2 );
...
{
	if (0) print( "fx_rod_of_smithing (%2d): ResRef:%s Anim:%s Type: %d\n", fx->Opcode, fx->Resource, fx->Resource2, fx->Parameter2 );
	int damage = 0;
...
{
	if (0) print( "fx_beholder_dispel_magic (%2d): Spell: %s\n", fx->Opcode, fx->Resource );
	if (!fx->Resource[0]) {
...
{
	if (0) print( "fx_harpy_wail (%2d): Spell: %s\n", fx->Opcode, fx->Resource );
	if (!fx->Resource[0]) {
...
{
	if (0) print( "fx_jackalwere_gaze (%2d): Spell: %s\n", fx->Opcode, fx->Resource );
	if (!fx->Resource[0]) {
...
{
	if (0) print( "fx_use_magic_device_modifier (%2d): Mod: %d, Type: %d\n", fx->Opcode, fx->Parameter1, fx->Parameter2 );
...
{
	if (0) print( "fx_protection_from_evil (%2d)\n", fx->Opcode);
	//
...
{
	if (0) print( "fx_armor_of_faith (%2d) Amount: %d\n", fx->Opcode, fx->Parameter1);
...
{
	if (0) print( "fx_fireshield (%2d) Type: %d\n", fx->Opcode, fx->Parameter2);
	if (fx->Parameter2) {
...
{
	if (0) print( "fx_righteous_wrath (%2d) Type: %d\n", fx->Opcode, fx->Parameter2);
	if (fx->Parameter2)
	{
...
{
	if (0) print( "fx_resilient_sphere (%2d)\n", fx->Opcode);
...
{
	if (0) print( "fx_bleeding_wounds (%2d): Damage: %d, Type: %d\n", fx->Opcode, fx->Parameter1, fx->Parameter2 );
...
{
	if (0) print( "fx_area_effect (%2d) Radius: %d, Type: %d\n", fx->Opcode, fx->Parameter1, fx->Parameter2);
...
{
	if (0) print( "fx_free_action_iwd2 (%2d)\n", fx->Opcode);
...
{
	if (0) print( "fx_unconsciousness (%2d): Type: %d\n", fx->Opcode, fx->Parameter2);
	STATE_SET(STATE_HELPLESS|STATE_SLEEP);
	if (fx->Parameter2) {
...
{
	if (0) print( "fx_entropy_shield (%2d)\n", fx->Opcode);
...
{
	if (0) print( "fx_protection_from_elements (%2d)\n", fx->Opcode);
...
{
	if (0) print( "fx_executioner_eyes (%2d)\n", fx->Opcode);
...
{
	if (0) print( "fx_projectile_use_effect_list (%2d) Type: %d Spell:%s\n", fx->Opcode, fx->Parameter2, fx->Resource);
...
{
	if (0) print( "fx_energy_drain (%2d) Type: %d\n", fx->Opcode, fx->Parameter1);
	if (!fx->Parameter1) {
		return FX_NOT_APPLIED;
	}
	if (fx->FirstApply) {
...
{
	if (0) print( "fx_tortoise_shell (%2d) Hits: %d\n", fx->Opcode, fx->Parameter1);
	if (!fx->Parameter1) {
		return FX_NOT_APPLIED;
	}
...
{
	if (0) print( "fx_persistent_use_effect_list (%2d) Interval: %d Resource: %.8s\n", fx->Opcode, fx->Parameter1, fx->Resource);
	if (fx->Parameter3) {
		fx->Parameter3--;
	} else {
		core->ApplySpell(fx->Resource, target, Owner, fx->Power);
...
{
	if (0) print( "fx_damage_reduction (%2d) Hits: %d  Strength: %d\n", fx->Opcode, fx->Parameter1, fx->Parameter2);
...
{
	if (0) print( "fx_barbarian_rage (%2d) Amount:%d\n", fx->Opcode, fx->Parameter1);
	//TODO: implement this
	return FX_APPLIED;
}
...
{
	if (0) print( "fx_missile_damage_reduction (%2d) Amount:%d\n", fx->Opcode, fx->Parameter1);
...
{
	if (0) print( "fx_alicorn_lance (%2d)\n", fx->Opcode);
...
{
	if (0) print( "fx_call_lightning (%2d)\n", fx->Opcode);
...
{
	if (0) print( "fx_globe_invulnerability (%2d)\n", fx->Opcode);
	int state;
	int icon;
	int value;
	int overlay;
...
{
	if (0) print( "fx_arterial_strike (%2d)\n", fx->Opcode);
